# 2. Total Technical Spec Validation — Genesis Organism — origin-to-birth total planning
...
- STEP_NUMBER=`2`
- STEP_ID=`total_spec_validate`
- STEP_TITLE=`Total Technical Spec Validation`
...
- Do not update `docs/features/genesis_organism/genesis_organism_phase_plan.md`.
