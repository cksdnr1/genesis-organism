# 4. Phase Implementation Plan Create — Genesis Organism — Machine Encounter revision
...
- Keep `docs/features/genesis_organism/encounter_revision_result.md` untouched unless documenting an unavoidable planning warning.
